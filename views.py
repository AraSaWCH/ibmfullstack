...
# you may implement it based on following logic:
         # Get user and course object, then get the associated enrollment object created 
         # when the user enrolled the course
...
#Create an exam result view def show_exam_result(request, course_id, submission_id): 
# to check if the learner passed exam
#as well as their question results. You may implement the view based on the following logic:
